...
export default function HomePage() {
  ...
  return (
    <PageShell currentPath="/">
      <section className="grid items-center gap-12 pb-24 pt-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16 lg:pb-32">
        <div className="space-y-8">
          <span className="pill bg-surface-high text-primary">
            Available for Projects
          </span>
          <h1 className="max-w-4xl font-display text-5xl font-extrabold leading-[1.02] tracking-[-0.05em] text-white sm:text-6xl lg:text-7xl">
            Eswar. <br />
        ...
        <div className="relative">
          <div className="absolute -right-10 -top-10 h-72 w-72 rounded-full bg-primary/10 blur-[120px]" />
          <div className="relative rounded-[28px] bg-surface-low p-4 shadow-ambient lg:rotate-3 lg:hover:rotate-0 lg:transition-transform lg:duration-700">
            <div className="relative h-[420px] overflow-hidden rounded-[22px] sm:h-[520px]">
              <Image
                src="/boy.jpg"
            ...
            <div className="absolute -bottom-5 left-4 rounded-[24px] border border-white/5 bg-surface-card p-5 shadow-ambient sm:-left-6 sm:p-6">
      ...
      <section className="section-panel space-y-10">
      ...
      <section className="grid gap-10 py-24 lg:grid-cols-[0.36fr_0.64fr] lg:gap-16 lg:py-32">
        ...
        <div className="space-y-10">
          {highlightedPosts.map((post, index) => (
            <article key={post.slug} className="group flex gap-4 sm:gap-8">
      ...
      <section className="cta-panel mb-8 rounded-[32px] px-6 py-16 sm:px-10 sm:py-20 lg:px-16 lg:py-24">
        <div className="relative z-10 mx-auto max-w-3xl text-center">
          <h2 className="font-display text-5xl font-extrabold tracking-[-0.04em] text-white sm:text-6xl">
            Want to work
            <br />
            with me?
          </h2>
          ...
          <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
            ...
            <Link href="/contact" className="rounded-xl bg-tertiary px-10 py-4 text-lg font-bold !text-[#3b002b] transition hover:brightness-110">
              Schedule a Call
            </Link>
          </div>
        </div>
